...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://overwatch:REMOVED-DEV-PASSWORD@localhost:5432/overwatch_db")
...
# Replace with:
# sqlalchemy.url = postgresql+asyncpg://overwatch:REMOVED-DEV-PASSWORD@localhost:5432/overwatch_db
```
